...
(function () {
  ...
  window.PadelAPI = {
    ...
    signup: (p1, p2, phone) => rpc("padel_signup", { p_player1: p1, p_player2: p2, p_phone: phone }),
    ...
    adminAddPair: (pass, p1, p2, phone) =>
      rpc("padel_admin_add_pair", { p_pass: pass, p_player1: p1, p_player2: p2, p_phone: phone }),
    adminUpdatePair: (pass, id, p1, p2, phone) =>
      rpc("padel_admin_update_pair", { p_pass: pass, p_id: id, p_player1: p1, p_player2: p2, p_phone: phone }),
    adminDeletePair: (pass, id) => rpc("padel_admin_delete_pair", { p_pass: pass, p_id: id }),
    adminCreateBracket: (pass, seeds, matches) =>
      rpc("padel_admin_create_bracket", { p_pass: pass, p_seeds: seeds, p_matches: matches }),
    adminResetBracket: pass => rpc("padel_admin_reset_bracket", { p_pass: pass }),
